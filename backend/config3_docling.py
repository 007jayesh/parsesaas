...
def extract_tables_config_3(pdf_path):
    """
    Config 3: Cell Matching ON + FAST Mode
    Balanced configuration with good speed and accuracy
    """
    start_time = time.time()
    
    # Pipeline options - Config 3
    pipeline_options = PdfPipelineOptions()
    pipeline_options.do_ocr = False
    pipeline_options.do_table_structure = True
    pipeline_options.table_structure_options.do_cell_matching = True  # ON
    ...
    # Build results
    all_tables = {
        "config_name": "Config 3: Cell Matching ON + FAST",
        "config_details": {
...
if __name__ == "__main__":
    ...
    print("Running Config 3: Cell Matching ON + FAST...")
    results = extract_tables_config_3(pdf_path)
